...
public class Retenido {
    ...
    public Retenido(String area, String zona, String cedula, String name, String celular, String numPedido, String neto, String saldo, String cupo, String cartera, String r_cupo, String code, String montoMinimo, String bloqueo, String minimoPublico, String totalPublico) {
        this.area = area;
        this.zona = zona;
        this.cedula = cedula;
        this.name = name;
