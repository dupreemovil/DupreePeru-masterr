...
public class CDR {
    ...
    public CDR(String campana, String fecha, String factura, String productos, String descripcion, String cantidad, String tReclamo, String procede, String observ) {
