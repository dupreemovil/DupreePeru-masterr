...
public class CatalogosFragment extends Fragment {
    ...
    private final String TAG = "CatalogosFragment";
    private final String BROACAST_CATALOGOS_SHARE = "broadcast_catalogos_share";
    private final String BROACAST_CATALOGOS_DOWNLOAD = "broadcast_catalogos_download";
    private final String BROACAST_CATALOGOS_DOWNLOADING_STATUS = "broadcast_catalogos_downloading_status";

    private final String BROACAST_CATALOGOS_OVERRIDE_FILE = "broadcast_catalogos_override_file";

    public static final String BROACAST_CATALOGOS_DOWNLOADING_ERROR="broadcast_catalogos_downloading_error";

    private final String BROACAST_CATALOGOS_DECIDE_DOWNLOAD_ONLINE = "broadcast_catalogos_decide_download_online";

    ImageView imgCamp_A, imgCamp_B;
    TextView txtNameCamp_A, txtNameCamp_B, txtNumCamp_A, txtNumCamp_B;
    ...
    private UrlCatalogo urlCatalogo;
    //Perfil perfil;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_catalogos, container, false);
        //perfil =getPerfil();

        progress = (ProgressBar) v.findViewById(R.id.progress);

        String jsonUrlCatalogos = mPreferences.getJSON_UrlCatalodos(getActivity());

        AppBarLayout AppBarL_FragCatg = (AppBarLayout) v.findViewById(R.id.AppBarL_FragCatg);
        ...
        imgCamp_A = (ImageView) v.findViewById(R.id.imgCamp_A);
        imgCamp_B = (ImageView) v.findViewById(R.id.imgCamp_B);

        txtNameCamp_A = (TextView) v.findViewById(R.id.txtNameCamp_A);
        txtNameCamp_B = (TextView) v.findViewById(R.id.txtNameCamp_B);
        txtNumCamp_A = (TextView) v.findViewById(R.id.txtNumCamp_A);
        txtNumCamp_B = (TextView) v.findViewById(R.id.txtNumCamp_B);


        if(jsonUrlCatalogos!=null) {
            responseUrlCatalogos = new Gson().fromJson(jsonUrlCatalogos, ResponseUrlCatalogos.class);
            txtNameCamp_A.setText(responseUrlCatalogos.getCatalogos().get(0).getCatalogo1().getName());
            txtNameCamp_B.setText(responseUrlCatalogos.getCatalogos().get(0).getCatalogo2().getName());
            txtNumCamp_A.setText(responseUrlCatalogos.getCatalogos().get(0).getCatalogo1().getCode());
            txtNumCamp_B.setText(responseUrlCatalogos.getCatalogos().get(0).getCatalogo2().getCode());
            ...
            //img.displayImage(responseUrlCatalogos.getCatalogos().get(0).getCatalogo1().getImage(), imgCamp_A);
            //img.displayImage(responseUrlCatalogos.getCatalogos().get(0).getCatalogo2().getImage(), imgCamp_B);
        ...
        imgCamp_A.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        imgCamp_B.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                urlCatalogo = responseUrlCatalogos.getCatalogos().get(0).getCatalogo2();
                testOnlineDownload(urlCatalogo.getName());
                //openCatalogoPDF(responseUrlCatalogos.getCatalogos().get(0).getCatalogo2().getUrl());
            }
        });
    ...
    public void sharedCatalog(){
        ...
        data.add(txtNameCamp_B.getText().toString());
        data.add(txtNameCamp_A.getText().toString());
    ...
    /*
    public boolean[] getItemSelected(String data){
        Log.e(TAG, data);
        ...
        switch (jsonShared){
            case "1":
                share+="el siguiente catálogo:\n\n"
                        .concat(responseUrlCatalogos.getCatalogos().get(0).getCatalogo1().getName())
                        .concat(", ")
                        .concat(responseUrlCatalogos.getCatalogos().get(0).getCatalogo1().getUrl());
                break;
            case "2":
                share+="el siguiente catálogo:\n\n"
                        .concat(responseUrlCatalogos.getCatalogos().get(0).getCatalogo2().getName())
                        .concat(", ")
                        .concat(responseUrlCatalogos.getCatalogos().get(0).getCatalogo2().getUrl());
                break;
            case "3":
                share+="los siguientes catálogos:\n\n"
                        .concat(responseUrlCatalogos.getCatalogos().get(0).getCatalogo1().getName())
                        .concat(", ")
                        .concat(responseUrlCatalogos.getCatalogos().get(0).getCatalogo1().getUrl());
                share+="\n\n";
