 ...
 */
public class CatalogosAdvanceFragment extends Fragment {
    private final String TAG = "CatalogosFrag_advance";
    ...
    ImageView imgCamp_A;
    TextView txtNameCamp_A, txtNumCamp_A;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_catalogos_advance, container, false);
        perfil =getPerfil();
        ...
        if(jsonUrlCatalogos!=null) {
            ...
            txtNameCamp_A.setText(responseUrlCatalogos.getCatalogos().get(0).getCatalogo3().getName());
            txtNumCamp_A.setText(responseUrlCatalogos.getCatalogos().get(0).getCatalogo3().getCode());

            img = ImageLoader.getInstance();
            img.init(PinchZoomImageView.configurarImageLoader(getActivity()));
            img.displayImage(responseUrlCatalogos.getCatalogos().get(0).getCatalogo3().getImage(), imgCamp_A);
        }
