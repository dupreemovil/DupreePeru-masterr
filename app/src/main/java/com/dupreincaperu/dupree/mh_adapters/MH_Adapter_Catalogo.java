...
public class MH_Adapter_Catalogo extends RecyclerView.Adapter<MH_Adapter_Catalogo.ViewHolder> {
    private List<Catalogo> listFilter;
    private String TAG = "MH_Adapter_Catalogo";
    ...
    public MH_Adapter_Catalogo(List<Catalogo> listFilter, Context mContext){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder  implements View.OnClickListener{
        ...
        private TextView tvPage, tvCode, tvDescription, tvValor, tvCantidad, tvAddCart, tvStatus;
