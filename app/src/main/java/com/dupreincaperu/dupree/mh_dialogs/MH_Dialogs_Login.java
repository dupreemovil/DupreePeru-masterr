...
public class MH_Dialogs_Login extends DialogFragment {
    ...
    MH_PagerAdapter_Login mh_pagerAdapter_login;
    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mh_pagerAdapter_login = new MH_PagerAdapter_Login(getChildFragmentManager());//se usa chield cuando desde un fragment se llama a otro
        ...
        vp.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                switch (position){
                    case MH_PagerAdapter_Login.PAGE_LOGIN:
                        controlArrow(false, true);
                        break;
                    case MH_PagerAdapter_Login.PAGE_FORGOT:
                        controlArrow(true, false);
                        break;
                    case MH_PagerAdapter_Login.PAGE_CODE:
                        controlArrow(true, false);
                        break;
                    case MH_PagerAdapter_Login.PAGE_PASSWORD:
                        controlArrow(true, false);
                        break;
                }
            }
